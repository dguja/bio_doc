...
\chapter{Rezultati}
U ovom poglavlju predstavljeni su rezultati implementacije child polja. \todo{napisati nesto kao za potrebe testiranja odabrane su dvije velike datoteke koje sadrzavaju genome bakterija (je li to tocno uopce?) i generirani su vlastiti primjeri}

\section{Vrijeme izvođenja}
\todo{u bioinformatici gdje raste broj dostupnih genoma, oni su veliki potrebno je paziti na vrijeme izvodenja - gradnja efikasnih algoritama. algoritam treba optimirati u svih koracima. child array je optimiran... tablica ova i ona prikazuje ...}
\begin{table}[h]
	\centering
...
\todo{genomi su veliki, time i algoritmi teze ka zauzimanju puno memorije... zbog ogranicenosti memorije, potrebno je paziti da algoritmi budu efikasni u iskoristavanju memorije...}
