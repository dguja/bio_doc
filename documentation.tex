...
U idućem je poglavlju dan kratki pregled \textit{essaMEM} algoritma. U poglavlju \ref{ch:child} opisano je \textit{child} polje i njegova konstrkcija. U poglavlju \ref{ch:results} opisan je način vrednovanja rješenja, prikazani su rezultati izvršavanja te usporedba s referentim rješenjem. Konačno, u poglavlju \ref{ch:conclusion} donesen je zaključak rada.
