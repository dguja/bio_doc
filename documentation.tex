...
\chapter{Rezultati}
U ovom poglavlju predstavljeni su rezultati implementacije child polja. Testovi su izvršeni nad generiranim nizovima te nad genomima sljedećih organizama: \textit{Escherichia coli}, \textit{Helicobacter pylori}, \textit{Methylobacillus flagellatus}. 
...
Tablica \ref{tbl:time-generated} prikazuje usporedbu vremena izgradnje child polja nad generiranim nizovima. Generirani nizovi imaju različite brojeve baza od $10^5$ do $10^7$. Vrijeme izvođenja izvedene implementacije i referentnog rješenja vrlo je slično te vrijede prethodni zaključci.
